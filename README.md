...
- 🤖 **Blixtsnabb AI-Agent (Anthropic)**: Vår agenter förstår kontext, läser inkommande svarvändningar och anpassar tonen för att bibehålla en god kundrelation samtidigt som de driver in skulden.
...
| **AI Motor** | Anthropic SDK (`@anthropic-ai/sdk`) |
...
graph TD
    ...
    C -->|Gäldenär svarar?| D{Analys (Anthropic)}
