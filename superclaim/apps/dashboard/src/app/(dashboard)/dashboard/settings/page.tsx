...
import { Save, Copy, Check, Globe, Loader2, Mail, RefreshCw, Link2, Unlink, Download } from 'lucide-react';
    ...
    const handleSave = async () => {
        ...
        try {
            const res = await fetch('/api/settings', {
                ...
                body: JSON.stringify({ email_preview: emailPreview, sms_preview: smsPreview, fortnox_auto_import: fortnoxAutoImport }),
            });
            if (res.ok) {
